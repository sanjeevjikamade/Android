Android Amazon Mobile Ads Swipeable Modeless Interstitial Ad Sample
...
5) Follow the Android developer instructions to install the support library: https://developer.android.com/tools/support-library/setup.html
6) Click on "Add External JARs" and add the android-support-v4.jar, located in android sdk directory, <sdk>/extras/android/support/v4.
7) Click on the "Order and Export" tab, and select the recently added JARs for export. Click "OK" to close out the properties dialog.
8) In the menu bar, select the "Project" menu and click "Build All" if it's not grayed out.
